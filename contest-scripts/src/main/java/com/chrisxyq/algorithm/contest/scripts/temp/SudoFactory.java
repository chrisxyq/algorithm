package com.chrisxyq.algorithm.contest.scripts.temp;//package com.example.algorithmcontest.com.chrisxyq.algorithm.contest.scripts.temp;
//
//
...
//            int com.chrisxyq.algorithm.contest.scripts.temp = board[0][col1];
//            board[0][col1] = board[0][col2];
//            board[0][col2] = com.chrisxyq.algorithm.contest.scripts.temp;
//        }
//        //任意交换元素
//        for (int i = 0; i < 9; ++i) {
//            int row = getRandomEight();
//            int col = getRandomEight();
//            int com.chrisxyq.algorithm.contest.scripts.temp = board[0][i];
//            board[0][i] = board[row][col];
//            board[row][col] = com.chrisxyq.algorithm.contest.scripts.temp;
//        }
//        /*step2：通过9个数字求出一个可行解*/
//        solveSudo();
...
//        //数组初始化为0
//        for (int com.chrisxyq.algorithm.contest.scripts.temp = 0; com.chrisxyq.algorithm.contest.scripts.temp < 10; ++com.chrisxyq.algorithm.contest.scripts.temp) {
//            possibleArray[com.chrisxyq.algorithm.contest.scripts.temp] = 0;
//        }
